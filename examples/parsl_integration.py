...
HighThroughputExecutor with EphemeralProvider.
...
-----
    ...
    uv run python examples/parsl_integration.py
...
# Worker init for Amazon Linux 2023 (the default AMI used by EphemeralProvider).
