...
def main():
    ...
    try:
        ...
        logger.info(f"To reconnect to this workflow later, use workflow_id: {workflow_id}")
        ...
        logger.info(f"You can reconnect to this workflow using workflow_id: {workflow_id}")
        time.sleep(10)
        ...
        logger.info(f"To terminate all resources later, reconnect with workflow_id: {workflow_id}")
