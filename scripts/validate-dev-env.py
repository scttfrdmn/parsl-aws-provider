...
def check_imports() -> List[Tuple[str, bool, str]]:
    ...
    imports_to_test = [
        ("parsl_ephemeral_provider", "Core package"),
        ("parsl_ephemeral_provider.provider", "Main provider"),
        ("parsl_ephemeral_provider.modes.standard", "Standard mode"),
        ("parsl_ephemeral_provider.modes.detached", "Detached mode"),
        ("parsl_ephemeral_provider.modes.serverless", "Serverless mode"),
        ("parsl_ephemeral_provider.compute.spot_fleet", "Spot Fleet manager"),
        ("parsl_ephemeral_provider.compute.lambda_func", "Lambda manager"),
        ("parsl_ephemeral_provider.constants", "Constants"),
        ("parsl_ephemeral_provider.exceptions", "Exceptions"),
    ]
