...
def configure_logger(
    logger_name: str = "parsl_ephemeral_provider",
    ...
    logger_name : str, optional
        Name of the logger, by default 'parsl_ephemeral_provider'
    level : int, optional
...
def set_all_loggers_level(level: int) -> None:
    ...
    """
    # Main logger
    logging.getLogger("parsl_ephemeral_provider").setLevel(level)

    # Submodule loggers
    for module in ["modes", "compute", "network", "state", "utils"]:
        logging.getLogger(f"parsl_ephemeral_provider.{module}").setLevel(level)
...
def configure_provider_logging(
    ...
    configure_logger(
        logger_name="parsl_ephemeral_provider",
        level=level,
