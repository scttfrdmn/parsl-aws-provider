...
class TestErrorHandlingIntegration:
    ...
    def test_spot_fleet_manager_error_handler_initialization(self):
        ...
        with patch("parsl_ephemeral_aws.compute.spot_fleet.CredentialManager"):
            with patch("boto3.Session"):
                ...
                assert (
                    manager.error_handler.retry_config.base_delay == 3.0
                )  # Longer delay
                assert (
                    manager.error_handler.retry_config.max_delay == 60.0
                )  # Spot-specific cap
    ...
    def test_spot_fleet_error_handling_specific_errors(
        self, mock_cred_manager, mock_session
    ):
