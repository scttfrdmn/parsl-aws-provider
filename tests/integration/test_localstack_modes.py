...
class TestStandardModeLocalstack:
    ...
    def test_initialize_and_cleanup(self, localstack_session, temp_state_store, provider_id):
        ...
        try:
            ...
            security_groups = ec2.describe_security_groups(GroupIds=[mode.security_group_id])
    ...
    @pytest.mark.localstack
    def test_submit_job_and_status(self, localstack_session, temp_state_store, provider_id):
...
class TestDetachedModeLocalstack:
    ...
    def test_submit_job_and_status(self, localstack_session, temp_state_store, provider_id):
        ...
        try:
            ...
            try:
                job_param = ssm.get_parameter(Name=f"/parsl/workflows/{workflow_id}/jobs/{job_id}")
                assert job_param["Parameter"]["Name"] == f"/parsl/workflows/{workflow_id}/jobs/{job_id}"
