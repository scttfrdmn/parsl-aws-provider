...
class TestSpotFleetCleanup(unittest.TestCase):
    ...
    def test_cleanup_spot_fleet_role_success(self):
        ...
        self.mock_iam.list_attached_role_policies.assert_called_once_with(RoleName='test-role')
    ...
    def test_cleanup_all_spot_fleet_resources(self):
        ...
        with patch('parsl_ephemeral_aws.compute.spot_fleet_cleanup.cleanup_spot_fleet_role') as mock_cleanup_role:
        ...
        self.assertEqual(result['cleaned_roles'][0], 'parsl-aws-spot-fleet-role-test-work')
        self.assertEqual(len(result['errors']), 0)
        
        # Verify client calls
        self.mock_ec2.get_paginator.assert_called_once_with('describe_spot_fleet_requests')
        ...
        mock_cleanup_role.assert_called_once_with(
            self.mock_session,
            'parsl-aws-spot-fleet-role-test-work'
        )
